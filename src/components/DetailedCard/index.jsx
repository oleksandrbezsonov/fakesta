...
const DetailedCard = ({
    ...
    const renderComments = () => {
        if (comments.length > 2 && !isCommentsShown) {
            ...
            return (
                <>
                    <span className="cnDetailedCardCommentTitle" onClick={() => setIsCommentsShown(true)}>{`Show ${comments.length - commentForRender.length} more comments`}</span>
